...
<?php $plugins=unserialize('a:1:{s:14:"main_left_MENU";a:1:{i:0;a:10:{i:0;s:1:"2";s:2:"id";s:1:"2";i:1;s:14:"article_widget";s:4:"name";s:14:"article_widget";i:2;s:14:"main_left_MENU";s:9:"layout_id";s:14:"main_left_MENU";i:3;s:16:"article_menu.php";s:3:"url";s:16:"article_menu.php";i:4;N;s:8:"sequence";N;}}}');?>
    ...
    <div class="main">
      <div class="main_wrap">
          ...
          <div id="sidebar" class="sidebar">
            <iframe onload="this.height=0" id="remind" name="remind" src="modules.php?app=remind" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
            ...
            <!--plugins!-->
             ...
             <!--好友生日提醒!-->
            <div class="sideitem">
              <?php require("modules/mypals/pals_fribirth.php");?>                
            </div>

            <!--好友推荐!-->
            <div class="sideitem last">
                <?php require("modules/users/user_fri_recommended.php");?>     
            </div>

						<div id="separator" class="switch" onclick="folden();"></div>
         </div>
      </div>
    </div>
    <div class="menu"><?php require("uiparts/mainleft.php");?></div>
  </div>
