...
<div class="album_photo_box">
    <a href="javascript:void(0)" onclick="<?php echo do_url($type,$val['photo_src'],$url_uid);?>;return false;" hidefocus="true"><?php src_wh($size[0],$size[1],$siteDomain.$val['photo_thumb_src']);?></a>
</div>
<?php }?>
